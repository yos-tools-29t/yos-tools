/**
 * UTC to IST Converter — tool logic
...
(function () {
  ...
  /**
   * @param {Date} date
   * @returns {{ date: Date, zone: "IST" }}
   */
  function convertUTCToIST(date) {
    return {
      date: new Date(date.getTime() + IST_OFFSET_MS),
      zone: "IST"
    };
  }
  ...
  function handleConvert(event) {
    ...
    var converted = convertUTCToIST(utcDate);
  ...
  function handleClear() {
    var input = document.getElementById("utc-input");
    var form = document.getElementById("utc-to-ist-form");
    if (form) form.reset();
